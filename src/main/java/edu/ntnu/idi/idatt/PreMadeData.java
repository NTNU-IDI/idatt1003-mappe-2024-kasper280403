...
public class PreMadeData {
    ...
    public static void addItems(){
        ...
        storage.updateStorage("carrot", 15.0, "stk", 2.90, "15-11-2024");
        ...
        storage.updateStorage("chicken", 1.2, "kg", 95.00, "03-11-2024");
        storage.updateStorage("pasta", 1.0, "kg", 18.50, "25-12-2024");
        storage.updateStorage("rice", 2.0, "kg", 30.00, "01-01-2025");
        storage.updateStorage("yogurt", 5.0, "stk", 10.90, "15-11-2024");
